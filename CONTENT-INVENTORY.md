...
- **Studio:** Landscape Design Studio 2 · **Semester 3** · Group project
- **Professors:** Strode Yves Hope · Protasoni Sara
- **Role:** Concept Design, Masterplan, Diagrams, Render
- **Software:** Rhino, Illustrator, Photoshop, QGIS
- **Spreads:** 04 (title + abstract), 05 (Manifest), 06 (Site analysis · Ecology),
  07 (Masterplan, full-bleed), 08 (perspectives · Signature moments)
...
- **Spreads:** 14 (title + abstract), 15 (Existing landscape · Landscape strategy),
  16 (The Chess · flood states), 17 (The Tower · The Bridge),
  18 (Masterplan · normal vs flood), 19 (Gridded Memories · final render)
...
- **Software:** Rhino, Illustrator, Photoshop, QGIS, Twinmotion
- **Spreads:** 20 (title + abstract), 21 (Strategy · four Fingers),
  22 (isometrics · Masterplan), 23 (renders · street design)
- **Abstract:** European territory transformed by metropolitan urbanisation and
  large infrastructure networks, producing an apparent polarisation between major
  cities and bypassed peripheral areas. Argues the contemporary urban territory
  is a network of interconnected landscapes rather than a rigid divide.
  Site: the Po plain between the Chiese and Oglio rivers, from the Pre-Alps to
  the Apennines, focused between the southern edge of Lake Garda and the Oglio.
- **Named moves:** "four Fingers" strategic vision for territorial organisation;
  "Reshaping the Waterway", "Expanding Green Networks", "Pathway to Nature",
  "Reflected Canopy"; "Harmony of Nature and Design"; "A Tranquil Border";
  "Bridging the Landscape"; a study of how street design shapes a driver's
  perception.
...
- **Description:** Integrating the relationship between children and urban
  facilities so children feel safe playing in the city. Traditional and locally
...
- **Deliverables:** logo, full brand book (2023–2025), stationery, envelope,
  business cards, signage, vehicle livery, catalogue, UI design and website.
- **Spreads:** 04 (branding), 05 (Heliotrope catalogue), 06 (UI + website),
  07 (book covers incl. Roboteos brand book)
...
- **Brief as written:** "sensitive to sharp colors while maintaining a creative,
  minimal, and architectural approach."
- **Deliverables:** logo and construction grid, envelope, business cards,
  stationery, brand book ("Creating childlike connection", 2023).
- **Spreads:** 06 (right), 07 (book covers)
- **Employment link:** "Architect and Landscape architect at Four And Seven,
  Dec 2021 – 2025".
...
### G5 · Architectural Graphics / Diagrams
- Multi-layered exploded axonometric diagrams: landscape transformations,
  topography, water management, ecological integration on one side; architectural
  and urban space, interior programming and functional relationships on the other.
- **Spreads:** 08
...
### G9 · Page layout
- Nine-up grid of interior page layouts, Persian and English, including the
  playground project documentation.
- **Spreads:** 06 (right, "Leyout")
...
| # | File | Mark | Category | Year |
|---|---|---|---|---|
| 01 | `02.jpg` | **DEJAN** | Construction company | 2022 |
| 02 | `03.jpg` | **8th Asian Men's Beach Handball Championship** (Iran) | Handball championship | 2022 |
| 03 | `04.jpg` | **PARS Magazine** | Magazine | 2018 |
| 04 | `05.jpg` | **TARAVAT Skin Care** | Beauty shop | 2021 |
...
different, more recent, architecture-led CV. They disagree materially.

The landscape CV is newer (2025) and matches the architecture-led direction, so
**it should be the basis for the About page.** Its content:

**Bio (verbatim):** "I have a background in architecture and have gained
experience working in various architecture firms. Additionally, I've freelanced
in graphic design. Throughout my career, I've strived to embody the qualities of
an architect, an artist, and a meticulous engineer. My involvement in numerous
environmental conservation initiatives prompted me to pursue a master's degree in
...
|---|---|---|
| Junior Architect | Ar.de.a. Arturo Montanelli Studio Design, Lecco, Italy | Sep 2024 – Feb 2025 |
| Architect & Landscape architect | Four And Seven, Iran | Dec 2021 – 2025 |
| Architect & Graphic Designer | Karoshan Construction Company, Iran | Oct 2019 – Dec 2021 |
| Junior Architect (apprenticeship) | Hajizadeh & Associates, Iran | Jan 2020 |
| Junior Architect | Vavan Urban Planning and Construction Company, Iran | Jan 2019 – Jun 2019 |
| Junior Architect | Houshang Ardalan and Partners Architecture Office, Iran | Nov 2017 – Oct 2018 |
| Graphic & Architecture Manager | Golabchi Foundation, Iran | Jul 2017 – Nov 2017 |

**Workshops:** 21st Century Architecture Kaleidoscope seminar (Oct 2018) ·
Architecture of Illusion (Sep 2020) · Anatomy of Public Space (May 2024) ·
Dialogues on Milan: City as a Common Resource, lecture by Alejandro Aravena (Apr 2024)

**Languages:** Persian native · English fluent · Italian elementary
**Interests:** Sketching · Architecture photography · Theater · Literature
**Skills:** Illustrator, Photoshop, InDesign, AllPlan, MS Office, Rhinoceros 3D,
AutoCAD, Revit, Twinmotion, Lumion, QGIS, Rhino V-Ray, SketchUp, Grasshopper

**Contact (both books agree):** +39 351 886 0362 · mjshoori.arch@gmail.com ·
IG @mj.shoori · linkedin.com/in/mjshoori · Behance Mohamadjavad Shoori ·
born 10/10/1996 Tehran, now Milan.
